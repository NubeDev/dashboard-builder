...
import WrapperRightClickMenu from 'src/components/blocks/WrapperRightClickMenu'
...
interface TreeDataItem {
  ...
  parentId?: string
  hightParentId?: string
  type?: string
  currentComponent?: RowModel | DragItemModel | (() => JSX.Element)
}
...
const Tree = React.forwardRef<HTMLDivElement, TreeProps>(
  (
    {
      data,
      initialSelectedItemId: initialSlelectedItemId,
      onSelectChange,
      expandAll,
      folderIcon,
      itemIcon,
      ...
      <div ref={ref} role="tree" className={className} {...props}>
        <ul>
          {data instanceof Array ? (
            data.map(item => (
              <WrapperRightClickMenu key={item.id} item={item}>
                <li>
                  {item.children ? (
              ...
              </WrapperRightClickMenu>
            ))
          ) : (
            <WrapperRightClickMenu item={data}>
              <li>
                <Leaf
                  item={data}
